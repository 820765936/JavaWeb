...
/**
 * Servlet implementation class UpdateOrderDeskServlet
 */
@WebServlet("/UpdateOrderDeskServlet")
public class UpdateOrderDeskServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateOrderDeskServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		updateOrderDao.updateOrderDesk(newDesk, orderId);
		out.print("换台成功！");
		out.flush();
		out.close();
	}
